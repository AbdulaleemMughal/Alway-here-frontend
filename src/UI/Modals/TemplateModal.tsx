        ...
        <Box sx={style}>
          <div className="p-4 flex items-center justify-between border-b border-gray-300">
            <div className="flex items-center gap-2.5">
              ...
              <h4 className="text-(--primary-color) font-[Spectral] font-medium text-[24px]">
                Pick a theme
              </h4>
            </div>
          ...
          <div className="py-6.25 px-9.75 flex flex-col items-center">
            <p className="font-[Poppins] text-(--secondary-color) mb-4 text-[16px]">
